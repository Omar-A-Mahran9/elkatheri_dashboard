        ...
        <div class="d-flex align-items-stretch justify-content-between flex-lg-grow-1">
            ...
            <div class="d-flex align-items-stretch flex-shrink-0">
                ...
                <div class="d-flex align-items-center ms-1 ms-lg-3" id="kt_header_user_menu_toggle">
                    <div class="px-4">
                        <small class="text-muted fs-7 fw-bold my-1 ms-1">{{ __("Hello") }} , {{ auth()->user()->name }}</small>
                    </div>
                    <!--begin::Menu wrapper-->
                    <div class="cursor-pointer symbol symbol-30px symbol-md-40px" data-kt-menu-trigger="click" data-kt-menu-attach="parent" data-kt-menu-placement="bottom-end">
                        <img src="{{asset('dashboard-assets/media/avatars/admin-avatar.png')}}" alt="user" />
                    </div>
                        ...
                        <div class="menu-item px-3">
                            <div class="menu-content d-flex align-items-center px-3">
                                ...
                                <div class="symbol symbol-50px me-5">
                                    <img alt="Logo" src="{{asset('dashboard-assets/media/avatars/admin-avatar.png')}}" />
                                </div>
                                <!--end::Avatar-->
                                <!--begin::Username-->
                        ...
                        <div class="menu-item px-5">
                            <div class="menu-content px-5">
                                <label class="form-check form-switch form-check-custom form-check-solid pulse pulse-success" for="toggle-theme-mode">
                                    <input class="form-check-input w-30px h-20px" type="checkbox" {{ isDarkMode() ? 'checked' : 'false' }} name="mode" id="toggle-theme-mode"  />
                    ...
                    <div class="menu menu-sub menu-sub-dropdown menu-column w-350px w-lg-375px" id="kt_menu" data-kt-menu="true" style="">
                        ...
                        <div class="d-flex flex-column bgi-no-repeat rounded-top" style="background-image:url('{{ asset('dashboard-assets/media/misc/menu-header-bg.jpg') }}')">
                            <div class="d-flex justify-content-between align-items-center">
                                ...
                                <!--end::Title-->
                                <a href="{{ route('dashboard.notifications.mark_all_as_read') }}" class="text-white fw-semibold px-9 mt-10 mb-6">{{ __('Mark all as read') }}</a>
                            </div>
                                    ...
                                    @forelse ($allNotifications->take(10)->get() as $notification)
                                        ...
                                        <div class="d-flex flex-stack py-4 notification-item">
                                            ...
                                            <div class="d-flex align-items-center">
                                                ...
                                                <!--begin::Title-->
                                                <div class="mb-0 me-2">
                                                    <a href="{{route('dashboard.notifications.mark_as_read', $notification->id)}}" class="fs-6 text-gray-800 text-hover-primary fw-bold">{{$notification->data['title_' . app()->getLocale()]}}</a>
