...
@section('content')
    ...
    <div class="card">
        ...
        <div class="card-body p-0">
            <!-- begin :: Form -->
            <form action="{{ route('dashboard.offers.update',$offer->id) }}" class="form" method="post" id="submitted-form" data-redirection-url="{{ route('dashboard.offers.index') }}">
            @csrf
            @method("PUT")
                ...
                <div class="card-header d-flex align-items-center">
                    ...
                    <div class="card-title">
                        ...
                        <div class="form-check form-switch form-check-custom form-check-solid mb-2">
                            ...
                            <input class="form-check-input mx-2" style="height: 18px;width:36px;" type="checkbox" name="status" @if( $offer['status'] ) checked @endif   />
                ...
                <div class="inputs-wrapper">
                    ...
                    <div class="row mb-10">
                        ...
                        <div class="col-md-12 fv-row d-flex justify-content-center">
                            ...
                            <div class="d-flex flex-column">
                                ...
                                <x-dashboard.upload-image-inp name="image" :image="$offer->image" directory="Offers" placeholder="default.jpg" type="editable" ></x-dashboard.upload-image-inp>
                    ...
                    <div class="row mb-10">
                        ...
                        <div class="col-md-6 fv-row">
                            ...
                            <div class="form-floating">
                                <input type="text" class="form-control" id="title_ar_inp" name="title_ar" value="{{ $offer['title_ar'] }}" placeholder="example"/>
                        ...
                        <div class="col-md-6 fv-row">
                            ...
                            <div class="form-floating">
                                <input type="text" class="form-control" id="title_en_inp" name="title_en" value="{{ $offer['title_en'] }}" placeholder="example"/>
                    ...
                    <div class="row mb-10">
                        ...
                        <div class="col-md-6 fv-row">
                            ...
                            <textarea id="tinymce_description_ar" name="description_ar" class="tinymce">{!! $offer['description_ar'] !!}</textarea>
                        ...
                        <div class="col-md-6 fv-row">
                            ...
                            <textarea id="tinymce_description_en" name="description_en" class="tinymce">{!! $offer['description_en'] !!}</textarea>
