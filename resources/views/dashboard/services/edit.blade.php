                ...
                <div class="card-header d-flex align-items-center">
                    ...
                    <div class="card-title">
                        <div class="form-check form-switch form-check-custom form-check-solid mb-2">
                            ...
                            <input class="form-check-input mx-2" style="height: 28px;width:60px;" type="checkbox" name="active" id="active-checkbox" @if ( $service['active'] ) checked @endif/>
                ...
                <div class="inputs-wrapper">
                    ...
                    <div class="row mb-10">
                        ...
                        <div class="col-md-6 fv-row">
                            ...
                            <textarea id="tinymce_description_ar" name="description_ar" class="tinymce">{{ $service->description_ar }}</textarea>
                        ...
                        <div class="col-md-6 fv-row">
                            ...
                            <textarea id="tinymce_description_en" name="description_en" class="tinymce">{{ $service->description_en }}</textarea>
