    ...
    <div class="card">
        ...
        <div class="card-body p-0">
            ...
            <form action="{{ route('dashboard.news.store') }}" class="form" method="post" id="submitted-form"
                  data-success-message="{{ __('News added successfully') }}" data-redirection-url="{{ route('dashboard.news.index') }}">
            @csrf
            <!-- begin :: Card header -->
                    ...
                    <div class="card-title">
                        <div class="form-check form-switch form-check-custom form-check-solid mb-2">
                            ...
                            <input class="form-check-input mx-2" style="height: 28px;width:60px;" type="checkbox"
                                   name="highlighted" id="highlighted-checkbox" checked/>
                ...
                <div class="inputs-wrapper">
                    ...
                    <div class="row mb-10">
                        ...
                        <div class="col-md-12 fv-row d-flex justify-content-evenly">
                            ...
                            <div class="d-flex flex-column" style="position:relative;">
                                ...
                                <p class="invalid-feedback" id="main_image" style="position: absolute; top: 100%; white-space: nowrap;"></p>
                            ...
                            <div class="d-flex flex-column" style="position:relative;">
                                ...
                                <x-dashboard.upload-image-inp name="cover_image" :image="null" :directory="null"
                                                              placeholder="default.jpg"
                                                              type="editable"></x-dashboard.upload-image-inp>
                                <p class="invalid-feedback" id="cover_image" style="position: absolute; top: 100%; white-space: nowrap;"></p>
                                <!-- end   :: Upload image component -->
                            </div>
                    ...
                    <div class="row mb-8">
                        ...
                        <div class="col-md-6 fv-row">
                            ...
                            <input type="text" class="form-control" id="tags_inp" name="tags"
                                   placeholder="{{ __("Enter the tags of the news") }}"/>
                    ...
                    <div class="row mb-10">
                        ...
                        <div class="col-md-12 fv-row">
                            ...
                            <textarea id="tinymce_description" name="description" class="tinymce"></textarea>
