                ...
                <div class="inputs-wrapper">
                    ...
                    <div class="row mb-8">
                        ...
                        <div class="col-md-6 fv-row">
                            ...
                            <label class="fs-5 fw-bold mb-2">{{ __("Job title") }}</label>
                                <input  class="form-control"  value="{{ $career['title'] }}" readonly />
                        </div>
                        <!-- end   :: Column -->
                        ...
                        <div class="col-md-6 fv-row">
                            ...
                            <input type="text" class="form-control" value="{{ $career['short_description'] }}" readonly />
                    ...
                    <div class="row mb-8">
                        ...
                        <div class="col-md-6 fv-row">
                            ...
                            <input type="text" class="form-control"  readonly value="{{ $career['address'] }}"/>
                        </div>
                        <!-- end   :: Column -->
                    ...
                    <div class="row mb-10">
                        ...
                        <div class="col-md-12 fv-row">
                            ...
                            <div> {!! $career['long_description'] !!} </div>
                        </div>
                        <!-- end   :: Column -->
