...
@section('content')
    ...
    <div class="toolbar">
        ...
        <div class="container-fluid d-flex flex-stack">
            ...
            <div data-kt-swapper="true" data-kt-swapper-mode="prepend"
                ...
                <!-- begin :: Title -->
                <h1 class="d-flex align-items-center text-dark fw-bolder fs-3 my-1"><a href="{{ route('dashboard.careers.index') }}" class="text-muted text-hover-primary">{{ __("Careers") }}</a></h1>
                <!-- end   :: Title -->
    ...
    <div class="card">
        ...
        <div class="card-body p-0">
            <!-- begin :: Form -->
            <form action="{{ route('dashboard.careers.store') }}" class="form" method="post" id="submitted-form" data-redirection-url="{{ route('dashboard.careers.index') }}">
                @csrf
                <!-- begin :: Card header -->
                <div class="card-header d-flex align-items-center">
                    ...
                    <div class="card-title">
                        <div class="form-check form-switch form-check-custom form-check-solid mb-2">
                            ...
                            <input class="form-check-input mx-2" style="height: 28px;width:60px;" type="checkbox" name="status" id="status-checkbox" checked  />
                ...
                <div class="inputs-wrapper">
                    ...
                    <div class="row mb-8">
                        ...
                        <div class="col-md-6 fv-row">
                            ...
                            <div class="form-floating">
                                <input type="text" class="form-control" id="short_description_inp" name="short_description" placeholder="example"/>
                    ...
                    <div class="row mb-10">
                        ...
                        <div class="col-md-12 fv-row">
                            ...
                            <textarea id="tinymce_long_description" name="long_description" class="tinymce"></textarea>
