        ...
        <div class="card-body fs-6 py-15 px-10 py-lg-15 px-lg-15 text-gray-700">
            ...
            <div class="d-flex flex-stack flex-wrap mb-15">
                ...
                <div class="d-flex align-items-center position-relative my-1 mb-2 mb-md-0">
                    ...
                    <input class="form-control form-control-solid ms-4 datepicker border-gray-300 border-1 filter-datatable-inp me-4" readonly placeholder="{{ __('Choose the date') }}" data-filter-index="6" />

                    <select class="form-select form-select-solid border-gray-300 border-1 filter-datatable-inp" data-filter-index="5" data-control="select2" data-dir="{{ isArabic() ? 'rtl' : 'ltr' }}" data-placeholder="{{ __("Choose the status") }}" >
                        <option value="" ></option>
                    ...
                    <select class="form-select form-select-solid border-gray-300 border-1 filter-datatable-inp ms-4" data-filter-index="3" data-control="select2" data-dir="{{ isArabic() ? 'rtl' : 'ltr' }}" data-placeholder="{{ __("Choose the city") }}" >
                        <option value="" ></option>
                        <option value="all" selected>{{ __("All") }}</option>
                ...
                <div class="d-flex justify-content-end" data-kt-docs-table-toolbar="base">
                    ...
                    <!-- begin :: Add Button -->
                    <a href="{{ route('dashboard.careers.create') }}" class="btn btn-primary" data-bs-toggle="tooltip" title="">
