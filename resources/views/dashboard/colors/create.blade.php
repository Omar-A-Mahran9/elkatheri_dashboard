...
@section('content')
    ...
    <div class="card">
        ...
        <div class="card-body p-0">
            <!-- begin :: Form -->
            <form action="{{ route('dashboard.colors.store') }}" class="form" method="post" id="submitted-form" data-redirection-url="{{ route('dashboard.colors.index') }}">
                @csrf
                <!-- begin :: Card header -->
                <div class="card-header d-flex align-items-center justify-content-between">
                    ...
                    <div class="card-title">
                        ...
                        <div class="form-check form-check-custom form-check-solid mx-4">
                            ...
                            <input class="form-check-input" type="radio" value="color" name="color_type" id="color-radio-btn"  checked />
                ...
                <div class="inputs-wrapper">
                    ...
                    <div class="row mb-4" id="colors-container">
                        ...
                        <div class="col-md-6 fv-row">
                            ...
                            <input type="color" name="hex_code" class="form-control" id="hex_code_inp" value="" style="height:47.5px"/>
                        ...
                        <div class="col-md-6 fv-row">
                            ...
                            <input type="text" class="form-control" name="hex_code" value="#000000" id="color_code_inp" readonly/>
