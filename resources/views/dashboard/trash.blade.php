        ...
        dataTableColumnsDefs.set('Car', [
                ...
                },
                {
                    ...
                    render: function (data, type, row) {
                        ...
                        return `<a class="d-block overlay" style="height:47px;" data-fslightbox="lightbox-basic" href="${getImagePathFromDirectory('Cars', data)}">
                                    <!--begin::Image-->
                                    <div class="overlay-wrapper bgi-no-repeat bgi-position-center bgi-size-cover card-rounded"
                                         style="height:56px;width:100px;border-radius:4px;margin:auto;background-image:url('${getImagePathFromDirectory('Cars', data)}');background-size:contain;">
                                    </div>
                                    <!--end::Image-->
