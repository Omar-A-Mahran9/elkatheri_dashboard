...
@section('content')
    ...
    <div class="card">
        ...
        <div class="card-body p-0">
            <!-- begin :: Form -->
            <form action="{{ route('dashboard.models.store') }}" class="form" method="post" id="submitted-form" data-redirection-url="{{ route('dashboard.models.index',['type' => request('type')]) }}" enctype="multipart/form-data">
                @csrf
...
@push('scripts')
    ...
    <script src="{{ asset('js/dashboard/forms/car_models/create.js') }}"></script>
@endpush
