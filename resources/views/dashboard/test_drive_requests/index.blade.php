    ...
    <div class="toolbar">
        ...
        <div  class="container-fluid d-flex flex-stack">
            ...
            <div data-kt-swapper="true" data-kt-swapper-mode="prepend" data-kt-swapper-parent="{default: '#kt_content_container', 'lg': '#kt_toolbar_container'}" class="page-title d-flex align-items-center flex-wrap me-3 mb-5 mb-lg-0">
                ...
                <!-- begin :: Title -->
                <h1 class="d-flex align-items-center text-dark fw-bolder fs-3 my-1">{{ __("Test drive requests") }}</h1>
                <!-- end   :: Title -->
        ...
        <div class="card-body fs-6 py-15 px-10 py-lg-15 px-lg-15 text-gray-700">
            ...
            <div class="d-flex flex-stack flex-wrap mb-15">
                ...
                <div class="d-flex align-items-center position-relative my-1 mb-2 mb-md-0">
                    ...
                    <input class="form-control form-control-solid ms-4 datepicker border-gray-300 border-1 filter-datatable-inp me-4" readonly placeholder="{{ __('Choose the test date') }}" data-filter-index="6" />

                    <select class="form-select form-select-solid w-200px ms-4 border-gray-300 border-1 filter-datatable-inp" data-filter-index="5" data-dir="{{ isArabic() ? 'rtl' : 'ltr' }}" data-control="select2" data-placeholder="{{ __("Status") }}" >
                        <option></option>
                ...
                <div class="d-flex justify-content-end" data-kt-docs-table-toolbar="base">
                    ...
                    <div class="w-200px" >
                        <!--begin::Select2-->
                        <input class="form-control form-control-solid border-gray-300 border-1 px-4 text-center filter-datatable-inp" data-filter-index="6"  placeholder="{{ __("Pick date range") }}" id="from_to_dp" />
                        <!--end::Select2-->
                    </div>
...
@push('scripts')
    ...
    <script src="{{ asset('js/dashboard/datatables/test_drive_requests.js') }}"></script>
    <script>
        ...
        fromToDp.daterangepicker({
            ...
            ranges: {
                '{{ __('All') }}' : [moment().subtract(50, "years"), moment().add(5, "years")],
