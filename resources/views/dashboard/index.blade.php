...
{{--                 @can('view_slider_dashboard')
                    <!--begin::Primary button-->
                    <a href="https://slider.alkathiricarshowroom.com?username={{ settings()->get('slider_dashboard_username') }}&password={{ settings()->get('slider_dashboard_password') }}" target="_blank" class="btn btn-sm btn-primary"><i class="fas fa-images fs-6"></i> {{ __("Slider dashboard") }} </a>
                    <!--end::Primary button-->
                @endcan --}}
                ...
                {{-- <div class="col-xl-4">
                    ...
                    <div class="card card-xl-stretch mb-xl-8">
                        ...
                        <div class="card-body d-flex flex-column p-0">
                            <div class="d-flex flex-stack flex-grow-1 card-p">
                                <div class="d-flex flex-column me-2">
                                    <a href="#" class="text-dark text-hover-primary fw-bolder fs-3">{{ __("All Clients") }}</a>
                                </div>
                                <span class="symbol symbol-50px">
