        ...
        <div class="card-body fs-6 py-15 px-10 py-lg-15 px-lg-15 text-gray-700">
                ...
                <div class="d-flex flex-stack flex-wrap mb-15">
                    ...
                    <div class="d-flex align-items-center position-relative my-1 mb-2 mb-md-0">
                        ...
                        <select class="form-select form-select-solid border-gray-300 border-1 filter-datatable-inp" data-filter-index="4" data-control="select2" data-dir="{{ isArabic() ? 'rtl' : 'ltr' }}" data-placeholder="{{ __("Choose the brand") }}" >
                            <option value="" ></option>
                    ...
                    <div class="d-flex justify-content-end" data-kt-docs-table-toolbar="base">
                        ...
                        <!-- begin :: Add Button -->
                        <a href="{{ route('dashboard.cars.create') }}" class="btn btn-primary" data-bs-toggle="tooltip" title="">
