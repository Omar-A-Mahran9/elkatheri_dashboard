...
@section('content')
    ...
    <div class="card">
        ...
        <div class="card-body p-0">
            <!-- begin :: Form -->
            <form action="{{ route('dashboard.tags.update',$tag->id) }}" class="form" method="post" id="submitted-form" data-redirection-url="{{ route('dashboard.tags.index') }}">
                @csrf
                @method('PUT')
                <!-- begin :: Card header -->
                    ...
                    <div class="row mb-8">
                        ...
                        <div class="col-md-6 fv-row">
                            ...
                            <div class="form-floating">
                                <input type="text" class="form-control" id="name_ar_inp" name="name_ar" value="{{ $tag['name_ar'] }}" placeholder="example"/>
                        ...
                        <div class="col-md-6 fv-row">
                            ...
                            <div class="form-floating">
                                <input type="text" class="form-control" id="name_en_inp" name="name_en" value="{{ $tag['name_en'] }}" placeholder="example"/>
