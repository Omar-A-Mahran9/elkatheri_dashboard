...
@section('content')
    ...
    <div class="card">
        ...
        <div class="card-body p-0">
            <!-- begin :: Form -->
            <form action="{{ route('dashboard.banks.store') }}" class="form" method="post" id="submitted-form" data-redirection-url="{{ route('dashboard.banks.index') }}">
                @csrf
                <!-- begin :: Card header -->
                <div class="card-header d-flex align-items-center">
                    <h3 class="fw-bolder text-dark">{{ __("Add new bank") }}</h3>
                </div>
                <!-- end   :: Card header -->
                ...
                <div class="inputs-wrapper">
                    ...
                    <div class="row mb-8">
                        ...
                        <div class="col-md-4 fv-row">
                            ...
                            <div class="form-floating">
                                <input type="text" class="form-control" id="owner_name_inp" name="owner_name" placeholder="example" value="شركة حمود منصور الكثيري المحدودة"/>
                        ...
                        <div class="col-md-4 fv-row">
                            ...
                            <div class="form-floating">
                                <input type="text" class="form-control" id="account_no_inp" name="account_no" placeholder="example"/>
                        ...
                        <div class="col-md-4 fv-row">
                            ...
                            <div class="form-floating">
                                <input type="text" class="form-control" id="iban_inp" name="iban" placeholder="example"/>
