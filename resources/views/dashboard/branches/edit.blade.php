                ...
                <div class="inputs-wrapper">
                    ...
                    <div class="row mb-8">
                        ...
                        <div class="col-md-6 fv-row">
                            ...
                            <div class="form-floating">
                                <input type="text" class="form-control" id="name_ar_inp" name="name_ar" value="{{ $branch['name_ar'] }}" placeholder="example"/>
                        ...
                        <div class="col-md-6 fv-row">
                            ...
                            <div class="form-floating">
                                <input type="text" class="form-control" id="name_en_inp" name="name_en" value="{{ $branch['name_en'] }}" placeholder="example"/>
                    ...
                    <div class="row mb-8">
                        ...
                        <div class="col-md-4 fv-row">
                            ...
                            <div class="form-floating">
                                <input type="text" class="form-control" id="address_ar_inp" name="address_ar" value="{{ $branch['address_ar'] }}" placeholder="example"/>
                        ...
                        <div class="col-md-4 fv-row">
                            ...
                            <div class="form-floating">
                                <input type="text" class="form-control" id="address_en_inp" name="address_en" value="{{ $branch['address_en'] }}" placeholder="example"/>
                        ...
                        <div class="col-md-4 fv-row">
                            ...
                            <div class="form-floating">
                                <input type="email" class="form-control" id="email_inp" name="email" value="{{ $branch['email'] }}" placeholder="example"/>
                    ...
                    <div class="row mb-8">
                        ...
                        <div class="col-md-4 fv-row">
                            ...
                            <div class="form-floating">
                                <input type="text" class="form-control" id="phone_inp" name="phone" value="{{ $branch['phone'] }}" placeholder="example"/>
                        ...
                        <div class="col-md-4 fv-row">
                            ...
                            <div class="form-floating">
                                <input type="text" class="form-control" id="whatsapp_inp" name="whatsapp" value="{{ $branch['whatsapp'] }}" placeholder="example"/>
                        ...
                        <div class="col-md-4 fv-row">
                            ...
                            <div class="form-floating">
                                <input type="text" class="form-control" id="frame_inp"  value="{{ $branch['frame'] }}" name="frame" placeholder="example"/>
                    ...
                    <div class="row mb-8">
                        ...
                        <div class="col-md-4 fv-row">
                            ...
                            <select class="form-select" data-control="select2" name="status" id="status-sp" data-placeholder="{{ __("Choose the status") }}" data-dir="{{ isArabic() ? 'rtl' : 'ltr' }}">
                                <option value="visible"   {{ $branch['status'] == "visible"   ? 'selected' : '' }} > {{ __("visible") }}</option>
                                <option value="invisible" {{ $branch['status'] == "invisible" ? 'selected' : '' }} > {{ __("invisible") }}</option>
                            </select>
                        ...
                        <div class="col-md-4 fv-row">
                            ...
                            <select class="form-select" data-control="select2" name="type" data-placeholder="{{ __("Choose branch type") }}" data-dir="{{ isArabic() ? 'rtl' : 'ltr' }}">
                                <option value="show_room" {{ $branch->type == 'show_room' ? 'selected' : '' }}> {{ __("Show room") }}</option>
                                <option value="maintenance_center" {{ $branch->type == 'maintenance_center' ? 'selected' : '' }}> {{ __("Maintenance center") }}</option>
                                <option value="3s_center" {{ $branch->type == '3s_center' ? 'selected' : '' }}> {{ __("3s center") }}</option>
                            </select>
