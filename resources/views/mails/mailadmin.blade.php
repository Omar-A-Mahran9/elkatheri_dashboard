                ...
                <td style="word-break: break-word;border-collapse: collapse !important;vertical-align: top">
                                                                ...
                                                                <tr>
                                                                    <td class="v-text-align"
                                                                        ...
                                                                        <img align="center" border="0"
                                                                            src="{{ asset('web/img/order-mail.png') }}"
                    ...
                    @if ($order->type == 'individual')
                                                                ...
                                                                <table width="100%" cellpadding="0" cellspacing="0"
                                                                    ...
                                                                    <tr>
                                                                        <td class="v-text-align"
                                                                            ...
                                                                            <img align="center" border="0"
                                                                                src="{{ $message->embed(getImagePathFromDirectory($order->car->main_image, 'Cars')) }}"
                                                                                alt="Car" title="Car"
                                                            ...
                                                            <td class="v-container-padding-padding"
                                                                ...
                                                                <h1 class="v-text-align v-font-size"
                                                                    ...
                                                                    Price: <strong> &nbsp; &nbsp; &nbsp; &nbsp; &nbsp;
                                                                        &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp;
                                                                        &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp;
                                                                        &nbsp;SAR{{ $order->car->selling_price }}</strong>
                                                                </h1>
                        ...
                        <div class="u-row-container" style="padding: 0px;background-color: transparent">
                                                    ...
                                                    <tbody>
                                                        <tr>
                                                            <td class="v-container-padding-padding"
                                                                ...
                                                                <h1 class="v-text-align v-font-size"
                                                                    style="margin: 0px; color: #ba372a; line-height: 140%; text-align: center; word-wrap: break-word; font-family: 'Rubik',sans-serif; font-size: 18px; font-weight: 400;">
                                                                    <strong>SAR{{ $order->car->selling_price }}</strong>
                                                                </h1>
                         ...
                         @elseif ($order->type == 'organization')
                        <div class="u-row-container" style="padding: 0px;background-color: transparent">
                            <div class="u-row"
                                style="margin: 0 auto;min-width: 320px;max-width: 600px;overflow-wrap: break-word;word-wrap: break-word;word-break: break-word;background-color: transparent;">
                                <div
                                                            ...
                                                            <td class="v-container-padding-padding"
                                                                ...
                                                                <h1 class="v-text-align v-font-size"
                                                                   ...
                                                                   Organization Name: <strong> &nbsp; &nbsp; &nbsp; &nbsp; &nbsp;
                                                                        &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp;
                                                                        &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp;
                                                                        &nbsp;{{ $order->organization_name }}</strong>
                                                                </h1>
                                                    ...
                                                    <tr>
                                                        <td class="v-container-padding-padding"
                                                            ...
                                                            <div class="v-text-align" align="center">
                                                                ...
                                                                <a href="https://alkathirimotors.com.sa/contact"
                                                                    target="_blank"
