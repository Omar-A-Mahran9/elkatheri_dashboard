                                                                ...
                                                                <tr>
                                                                    <td class="v-text-align"
                                                                        ...
                                                                        <img align="center" border="0"
                                                                            src="{{ asset('web/img/order-mail.png') }}" alt="email icon"
                                                                            title="email icon"
                                                ...
                                                <tbody>
                                                    <tr>
                                                        <td class="v-container-padding-padding"
                                                            ...
                                                            <h1 class="v-text-align v-font-size"
                                                                style="margin: 0px; line-height: 140%; text-align: left; word-wrap: break-word; font-family: 'Rubik',sans-serif; font-size: 18px; font-weight: 400;">
                                                                <strong>Your order details</strong></h1>
                                                                ...
                                                                <table width="100%" cellpadding="0" cellspacing="0"
                                                                    ...
                                                                    <tr>
                                                                        <td class="v-text-align"
                                                                            ...
                                                                            <img align="center" border="0"
                                                                                src="{{  $message->embed(getImagePathFromDirectory($order->car->main_image, 'Cars'))  }}" alt="Car"
                                                                                title="Car"
                                                    ...
                                                    <tbody>
                                                        <tr>
                                                            <td class="v-container-padding-padding"
                                                                ...
                                                                <h1 class="v-text-align v-font-size"
                                                                    style="margin: 0px; line-height: 140%; text-align: left; word-wrap: break-word; font-family: 'Rubik',sans-serif; font-size: 18px; font-weight: 400;">
                                                                    <strong>{{ $order->car->name }}</strong></h1>
                                                    ...
                                                    <tbody>
                                                        <tr>
                                                            <td class="v-container-padding-padding"
                                                                ...
                                                                <div class="v-text-align v-font-size"
                                                                    style="font-size: 14px; line-height: 170%; text-align: left; word-wrap: break-word;">
                                                                    <p style="font-size: 14px; line-height: 170%;">{{ $order->type }}</p>
                                                                </div
                                                    ...
                                                    <tbody>
                                                        <tr>
                                                            <td class="v-container-padding-padding"
                                                                ...
                                                                <h1 class="v-text-align v-font-size"
                                                                    style="margin: 0px; color: #ba372a; line-height: 140%; text-align: left; word-wrap: break-word; font-family: 'Rubik',sans-serif; font-size: 18px; font-weight: 400;">
                                                                    Price: <strong> &nbsp; &nbsp; &nbsp; &nbsp; &nbsp;
                                                                        &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp;
                                                                        &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp;
                                                                        &nbsp;${{ $order->car->selling_price }}</strong></h1>
                                                    ...
                                                    <tbody>
                                                        <tr>
                                                            <td class="v-container-padding-padding"
                                                                ...
                                                                <h1 class="v-text-align v-font-size"
                                                                    style="margin: 0px; color: #ba372a; line-height: 140%; text-align: center; word-wrap: break-word; font-family: 'Rubik',sans-serif; font-size: 18px; font-weight: 400;">
                                                                    <strong>${{ $order->car->selling_price }}</strong></h1>
                                                    ...
                                                    <tr>
                                                        <td class="v-container-padding-padding"
                                                            ...
                                                            <div class="v-text-align" align="center">
                                                                ...
                                                                <a href="https://alkathirimotors.com.sa/contact" target="_blank"
