...
Route::get('/models/{brandId}', 'Dashboard\ModelController@getModelsByBrand');
Route::group(['namespace' => 'Home' , 'middleware' => 'set_locale'] , function () {

    Route::redirect('/', 'employee/login')->name('home.index');
...
Route::get('/slider', function(){
    ...
    return [
        'head' => file_get_contents( public_path('js/home/jQuery.js')) . "<script> var $ = jQuery.noConflict(); </script>" . file_get_contents("https://slider.rotanacarshowroom.com/RevSliderEmbedderheadIncludes.php"),
