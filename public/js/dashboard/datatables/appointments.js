        ...
        datatable = $("#kt_datatable").DataTable({
            ...
            ajax: {
                data: function () {
                    ...
                    datatable.DataTable().ajax.url(`/dashboard/appointments?page=${info.page + 1}&per_page=${info.length}`);
                }
            },
            columns: [
                {data: 'id'},
            ...
            columnDefs: [
                ...
                },
                {
                    targets: 4,
                    render: function (data, type, row) {
                        return row.model ? row.model.name + ' ' + row.model_year : row.model_name + ' ' + row.model_year;
                    }
                },
                {
                    targets: -1,
                        ...
                        return `
                            ...
                            <div class="menu menu-sub menu-sub-dropdown menu-column menu-rounded menu-gray-600 menu-state-bg-light-primary fw-bold fs-7 w-125px py-4" data-kt-menu="true">
                                ...
                                <div class="menu-item px-3">
                                    <a href="/dashboard/appointments/${ row.id }" class="menu-link px-3 d-flex justify-content-between" >
                                ...
                                <!--begin::Menu item-->
                                <div class="menu-item px-3">
                                    <a href="/dashboard/appointments/${ row.id }/edit" class="menu-link px-3 d-flex justify-content-between" >
                                       <span> ${translate('Edit')} </span>
                                       <span>  <i class="fa fa-edit text-black-50"></i> </span>
                                    </a>
                                </div>
                                <!--end::Menu item-->
            ...
            deleteAlert(type).then(function (result) {
                ...
                if (result.value) {
                    ...
                    $.ajax({
                        ...
                        url: '/dashboard/appointments/' + rowId,
                        success: () => {
