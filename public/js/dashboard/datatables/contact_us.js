            ...
            columnDefs: [
                ...
                },
                {
                    ...
                    render:function (data, type, row) {
                        ...
                        return `<a     onclick="showMoreInDT(this)" > <span  class="cursor-pointer" title="${ translate('show more')}" >${ data.substr(0, 18) }</span> </a>
                                <span  title="${ translate('show more')}"> ${ data.length > 18 ? '...' : ''} </span>
