        ...
        datatable = $("#kt_datatable").DataTable({
            ...
            ajax: {
                data: function () {
                    ...
                    datatable.DataTable().ajax.url(`/dashboard/colors?page=${info.page + 1}&per_page=${info.length}`);
                }
            },
            columns: [
                {data: 'id'},
            ...
            columnDefs: [
                ...
                },
                {
                    ...
                    render: function (data, type, row) {
                        if ( data !== null )
                            return `<img style="height:30px;width:30px" src="${getImagePathFromDirectory('Colors', data)}" class="me-3 rounded-circle" >`;
                        else
                            return "<h1>-</h1>"
                    }
                },
                        ...
                        return `
                            ...
                            <div class="menu menu-sub menu-sub-dropdown menu-column menu-rounded menu-gray-600 menu-state-bg-light-primary fw-bold fs-7 w-125px py-4" data-kt-menu="true">
                                ...
                                <div class="menu-item px-3">
                                    <a href="/dashboard/colors/${ row.id }/edit" class="menu-link px-3 d-flex justify-content-between edit-row" >
                                ...
                                <!--begin::Menu item-->
                                <div class="menu-item px-3">
                                    <a href="/dashboard/colors/${ row.id }" class="menu-link px-3 d-flex justify-content-between" >
                                ...
                                <!--begin::Menu item-->
                                <div class="menu-item px-3">
                                    <a href="#" class="menu-link px-3 d-flex justify-content-between delete-row" data-row-id="${row.id}" data-type="${translate('color')}">
